...
function AppProvider(props){
    ...
    return (
        <AppContext.Provider 
            value={{displayedContacts, searchValue, setSearchValue, modalOpen, toggleModal, newContact, updateNewName, updateNewNumber, addNewContact, openNewContactModal, editingContact, openEditingContactModal, contactModal, updateContactName, updateContactNumber, updateContact, deleteContact}}
        >
            {props.children}
        </AppContext.Provider>
    )
